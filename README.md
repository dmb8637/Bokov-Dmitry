...
<ul><strong>ОГЛАВЛЕНИЕ:</strong>
  ...
  <li><a href="#inolang">Владение иностранными языками</a></li>
  <li><a href="#mainexp">Основные достижения</a></li>
...
<div class = "_mainexp">
  ...
  <br><img src="sertRPA_BokovDA.png" title="Нажмите для увеличения" height="140" valign="top" align="left" style="border: 10px solid transparent;"  onclick="openImg(this.src)">
		</div>
	</details>
	<details class = "item">
		<summary class = "ask">Реализованные проекты</summary>
		<div class = "answer">
			  <ul><li>Участие в проекте ПАО Сбербанк “Витрины устройств самообслуживания”, непосредственное участие в разработке (кластерный анализ) в сентябре 2017 года.</li>
  <li>Участие в проекте ПАО Сбербанк “Автоматическая диспетчеризация распределения задач залоговой службы”, непосредственное участие в разработке (RPA) в июне 2019 года.</li></ul>
		</div>
	</details>
	<details class = "item">
