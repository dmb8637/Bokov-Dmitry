...
<ul><strong>ОГЛАВЛЕНИЕ:</strong>
  ...
  <li><a href="#mainexp">5. Основные достижения</a></li>
...
<br>2021
 ...
 - автотестирование, GUI-автоматизация
 - применение Jenkins, GIT для обесечения непрерывной интеграции ПО
 - верстка диалоговых форм, страниц сайтов, фреймов для клиентов (JS, HTML, CSS) - фриланс
